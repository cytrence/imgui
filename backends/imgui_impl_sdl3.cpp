...
{
    ImGui_ImplSDL3_Data* backend_data = ImGui_ImplSDL3_GetBackendData();
    ...
    if (data->WantVisible)
    {
        ...
        SDL_SetTextInputRect(backend_data->Window, &r);
        SDL_StartTextInput(backend_data->Window);
    }
    else
    {
        SDL_StopTextInput(backend_data->Window);
    }
}
